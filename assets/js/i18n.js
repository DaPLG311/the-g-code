...
(function () {
  ...
  function build() {
    ...
    css.textContent =
      ".d1-langbar{position:fixed;top:10px;left:50%;transform:translateX(-50%);z-index:1200;display:flex;gap:2px;" +
      "background:rgba(8,9,12,0.82);border:1px solid rgba(200,168,106,0.45);border-radius:999px;padding:3px;" +
      "-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);box-shadow:0 8px 24px -10px rgba(0,0,0,0.7);}" +
      ".d1-langbar button{appearance:none;border:0;background:transparent;color:#C9CCD3;cursor:pointer;" +
      "font-family:'Oswald',sans-serif;font-size:11px;letter-spacing:0.08em;line-height:1;padding:7px 12px;border-radius:999px;" +
      ...
      "html[dir=rtl] .smoke,html[dir=rtl] .foot-col,html[dir=rtl] .cat,html[dir=rtl] .method-card{text-align:right;}" +
      "html[dir=rtl] .cta-sub-left{text-align:right;}" +
      "@media(max-width:820px){.d1-langbar{top:auto;bottom:12px;}body.galaxy-page .d1-langbar{display:none;}}";
